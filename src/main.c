...
void displayInit(){
    ...
    tftWriteCommand(0xFF,0x01);
    tftWriteCommand(0xE3,0x00);
    tftWriteCommand(0x0A,0x11);
    tftWriteCommand(0x23,0xA0); //A2
    tftWriteCommand(0x24,0x32);
    tftWriteCommand(0x25,0x12);
    tftWriteCommand(0x26,0x2E);
    tftWriteCommand(0x27,0x2E);
    tftWriteCommand(0x29,0x02);
    tftWriteCommand(0x2A,0xCF);
    tftWriteCommand(0x32,0x34);
    tftWriteCommand(0x38,0x9C);
    tftWriteCommand(0x39,0xA7);
    tftWriteCommand(0x3A,0x27); 
    tftWriteCommand(0x3B,0x94);
    tftWriteCommand(0x42,0x6D);
    tftWriteCommand(0x43,0x83);
    tftWriteCommand(0x81,0x00);
    tftWriteCommand(0x91,0x67);
    tftWriteCommand(0x92,0x67);
    tftWriteCommand(0xA0,0x52);
    tftWriteCommand(0xA1,0x50);
